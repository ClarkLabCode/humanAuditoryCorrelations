function [outStruct] = pipDeltaTimeSuppFunction(params)
...
% Time between pips
pipDeltaT = params.pipDeltaT; % key variable for this experiment

% Duration of each pip
pipDur = params.pipDur; % shortened in this experiment

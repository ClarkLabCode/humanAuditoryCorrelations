function [outStruct] = correlatedPipsFunction(params)
...
% New
corrPipTypeNumber = params.corrPipTypeNumber; % in range 0-4, with effects shown below
...
switch corrType
    ...
    case 'corrPips'
        ...
        elseif length(corrPipType) == 2
            ...
            playNote1 = playNote1*corrPipType(1); % set these up

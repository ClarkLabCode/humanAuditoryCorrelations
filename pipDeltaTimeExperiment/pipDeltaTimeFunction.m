function [outStruct] = pipDeltaTimeFunction(params)
...
% Which stimulus type is played
corrType = params.corrType;

% Key variable for this experiment
pipDeltaT = params.pipDeltaT; % time between pips
pipDur = params.pipDur; % duration of each pip

% Correlation or direction
...
% Potential stimulus types ('corrPips for this experiment)
switch corrType
    ...
    case 'corrPips'
        dens = 4; % Hz, density of pips per tone, per second

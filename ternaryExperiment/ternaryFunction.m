function [outStruct] = ternaryFunction(params)

%% Variables set by params

% Stimulus duration
T = params.stimDur; % seconds
...
deltaT = params.deltaT; % how many notes to move with correlation in time dimension

% Which type of stimulus is played
corrType = params.corrType; % 'ternScint', 'ternRandom', 'glider'
...
% Set scale
scale = 100*2.^[1:1/nTones:6-1/nTones]; % order 20 notes being played per octave -- equal number for all harmonics
